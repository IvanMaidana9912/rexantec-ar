...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-16">
      ...
      {/* Imagen + Acordeón */}
      <div className=" container mx-auto px-4 sm:px-6 lg:px-0 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center justify-items-center"
        data-aos="fade-left"
        data-aos-delay="200">
        {/* Imagen */}
        <div className=" w-full max-w-xs sm:max-w-sm md:max-w-md aspect-[4/3] rounded-tr-[100px] rounded-bl-[100px] overflow-hidden border border-gray-200 mx-auto"
          data-aos="fade-left"
          data-aos-delay="300">
          <Image
            ...
            return (
              <div key={idx}>
                <button
                  ...
                  <span className={` flex items-center ${isOpen ? 'text-[#E22128]' : 'text-gray-800'} text-lg font-semibold text-center md:text-start`}>
                    {isOpen ? (
                ...
                <div className={` overflow-hidden bg-white text-gray-700 transition-all duration-300 ease-in-out px-6 ${isOpen ? 'max-h-60 py-4' : 'max-h-0 py-0'}`}>
