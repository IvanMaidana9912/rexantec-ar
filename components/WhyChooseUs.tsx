...
export default function WhyChooseUs() {
  return (
    <section id="nosotros" className="py-16 bg-white">
      <div className="mx-auto px-6 sm:px-8 md:px-12 lg:px-0 text-center">
        ...
        <div className="h-1 bg-red-600 w-24 sm:w-48 md:w-64 lg:w-72 mx-auto mb-16" />

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mx-4 sm:mx-6 lg:mx-[35rem]">
