...
const DIALOG_US: ChooseUs[] = [
  {
    icon: 'Assignment-turned-in.png',
    title: 'Garantía',
    desc: 'Proveemos en todos nuestros equipos y servicios garantía total con el mejor servicio de atención al cliente.',
  },
  {
    icon: 'Build.png',
    title: 'Profesionales',
    desc: 'Contarás con un equipo de profesionales para diseñar y presupuestar la climatización de tu espacio.',
  },
  {
    icon: 'Verified-Account.png',
    title: 'Trayectoria',
    desc: 'Nos dedicamos a la climatización de espacios desde 1999, tendrás a tu disposición toda nuestra experiencia.',
  },
];
    ...
    <section id="nosotros" className="py-16 bg-[#0f446ca1]">
      <div
        ...
        <div
          ...
          data-aos-delay="400">
          {
            DIALOG_US.map(({ icon, title, desc }, i) => (
              <div
                key={title}
